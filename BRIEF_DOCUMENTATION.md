...
An interface to provide a communication channel between components, that need to update when the system locale (languageú has been changed), usually UI components.
